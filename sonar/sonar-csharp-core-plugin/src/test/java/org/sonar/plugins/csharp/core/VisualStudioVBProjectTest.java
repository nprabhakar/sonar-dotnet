...
public class VisualStudioVBProjectTest {
  ...
  public void initBuilder() {
    ...
    // TODO: Introduce new VBConfiguration class??
  ...
  public void testCorrectlyConfiguredProject() throws Exception {
    conf.setProperty(CSharpConstants.SOLUTION_FILE_KEY, "TestVBSolution.sln");
    projectBuilder.build(reactor);
    ...
    VisualStudioProject vsProject = microsoftWindowsEnvironment.getCurrentProject("TestVBProject");
    assertThat(subProject.getName(), is("TestVBProject"));
    assertThat(subProject.getKey(), is("groupId:TestVBProject"));
